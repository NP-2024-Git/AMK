...
<svg xmlns="http://www.w3.org/2000/svg" height="200px" width="200px" viewBox="0 0 200 200" class="pencil">
  ...
  <circle transform="rotate(-113,100,100)" stroke-linecap="round" stroke-dashoffset="439.82" stroke-dasharray="439.82 439.82" stroke-width="2" stroke="currentColor" fill="none" class="pencil__stroke"></circle>
...
.pencil__body1 { animation-name: pencilBody1; transform: rotate(-90deg); }
.pencil__body2 { animation-name: pencilBody2; transform: rotate(-90deg); }
.pencil__body3 { animation-name: pencilBody3; transform: rotate(-90deg); }
